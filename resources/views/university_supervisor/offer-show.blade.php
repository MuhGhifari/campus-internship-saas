...
@section('content')
    ...
    <button type="button" data-back-button data-fallback="{{ route('applications.index') }}" class="mb-5 inline-flex items-center gap-2 rounded-lg border border-[#0D1B2A]/15 bg-white px-4 py-2 text-sm font-semibold text-[#0D1B2A] hover:bg-[#F7F3ED]">
