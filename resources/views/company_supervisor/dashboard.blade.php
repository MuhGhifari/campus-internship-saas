...
@section('content')
    @php
        ...
        $hero = match (true) {
            ...
            $user->hasRole('company_supervisor') => ['Meja PJ Perusahaan', 'Pantau tugas, progres, dan evaluasi mahasiswa yang ditugaskan.', 'mentor', route('logbooks.index'), 'Tinjau Tugas'],
